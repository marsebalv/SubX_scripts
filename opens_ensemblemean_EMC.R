...
groups=c('EMC')                        # Modeling Groups (must be same # elements as models below)
models=c('GEFS')               # Model Name (must be same # of elements as groups above)
...
nleads=c(35)  # number of lead (per model)
nenss=c(11)    # it really has 1, but will be used as 4 members (1 each day)
...
sdat=887 # number of start dates to allocate final array
