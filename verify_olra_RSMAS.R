# SubX data - olr anomaly verification for RSMAS model (SubX database)
#
# M. Alvarez - 2020
#-----------------------------------------------------------------------------------------------------------------------
rm(list=ls())
...
#  Main Program  
#---------------------------------------------------------------------------------------
dt.verif = readRDS("/home/alvarez/SubX_processed_Rdata/toverif_RSMAS_ONDEFMA.rds")
...
fig <- grid.arrange(g1,g2,g4, ncol = 1,top = textGrob("SubX RSMAS-CCSM4 rluta (99-15, Oct-Apr)",gp=gpar(fontsize=13,font=3)))
ggsave(filename="/home/alvarez/SubX_processed_Rdata/scores_map_RSMAS.png",plot=fig,width = 10, height = 11)
