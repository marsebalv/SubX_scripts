# SubX data - olr anomaly verification for EMC model (SubX database)
#
# M. Alvarez - 2020
#-----------------------------------------------------------------------------------------------------------------------
rm(list=ls())
...
#  Main Program  
#---------------------------------------------------------------------------------------
dt.verif = readRDS("/home/alvarez/SubX_processed_Rdata/toverif_EMC_ONDEFMA.rds")
...
fig <- grid.arrange(g1,g2,g4, ncol = 1,top = textGrob("SubX EMC-GEFS rluta (99-15, Oct-Apr)",gp=gpar(fontsize=13,font=3)))
ggsave(filename="/home/alvarez/SubX_processed_Rdata/scores_map_EMC.png",plot=fig,width = 10, height = 11)
