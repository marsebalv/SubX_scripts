# SubX data - SIS index verification for NRL model (SubX database)
#
# M. Alvarez - 2020
#-----------------------------------------------------------------------------------------------------------------------
rm(list=ls())
...
#  Main Program  
#---------------------------------------------------------------------------------------
dt.verif = as.data.table(readRDS("/home/alvarez/SubX_processed_Rdata/toverif_NRL_ONDEFMA.rds"))
...
save(dt.fcstSIS, file = "~/SubX_scripts/SubX_SIS_index_forecast_NRL.rda")
#--------------------------------------------------------------------
# Gráfico
...
fig <- grid.arrange(g1,g2,g3,g4, ncol = 1,top = textGrob(paste0("SubX NRL EM SIS index forecast season ",as.character(yi),"/",as.character(yi+1)),gp=gpar(fontsize=13,font=3)))
ggsave(filename=paste0("/home/alvarez/SubX_processed_Rdata/SIS_index_forecast_NRL_",as.character(yi),"_",as.character(yi+1),".png"),plot=fig,width = 11, height = 14)
