...
groups=c('RSMAS')                        # Modeling Groups (must be same # elements as models below)
models=c('CCSM4')               # Model Name (must be same # of elements as groups above)
...
nenss=c(3)    # it really has 1, but will be used as 4 members (1 each day)
...
sdat=1937 # number of start dates to allocate final array
